...
function App() {
  ...
  const [newGroup, setNewGroup] = useState<Partial<Group>>({ name: '', order_num: 0, hidden: false });
  ...
  const handleOpenAddGroup = () => {
    setNewGroup({ name: '', order_num: groups.length, hidden: false });
              ...
              {sortMode !== SortMode.None ? (
                ...
                <>
                  ...
                  >
                    ...
                    {!isAuthenticated && (
                      <MenuItem onClick={() => setShowLoginForm(true)}>
                        <ListItemIcon>
